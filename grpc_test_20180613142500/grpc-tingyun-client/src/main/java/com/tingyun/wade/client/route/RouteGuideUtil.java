...
import com.tingyun.wade.server.routeguide.FeatureDatabase;
import com.tingyun.wade.server.routeguide.Point;
...
public class RouteGuideUtil {
    ...
    public static URL getDefaultFeaturesFile() {
        return RouteGuideService.class
                .getClassLoader().getResource("route_guide_db.json");
    }
