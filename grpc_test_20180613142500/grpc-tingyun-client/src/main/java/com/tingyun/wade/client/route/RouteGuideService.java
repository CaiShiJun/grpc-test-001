...
package com.tingyun.wade.client.route;

import com.google.common.annotations.VisibleForTesting;
import com.google.protobuf.Message;
import com.tingyun.wade.server.routeguide.*;
...
public class RouteGuideService {
     ...
     */
    public RouteGuideService(String host, int port) {
     ...
     */
    public RouteGuideService(ManagedChannelBuilder<?> channelBuilder) {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        RouteGuideService client = new RouteGuideService("localhost", 8089);
        try {
    ...
    public CountDownLatch  routeGetChat(){
        RouteGuideService client=new RouteGuideService("localhost",8089);
        CountDownLatch countDownLatch=client.routeChat();
