package com.tingyun.wade.server.manualflowcontrol;
...
public final class StreamingGreeterGrpc {
  ...
  public static final io.grpc.MethodDescriptor<com.tingyun.wade.server.manualflowcontrol.HelloRequest,
      com.tingyun.wade.server.manualflowcontrol.HelloReply> METHOD_SAY_HELLO_STREAMING =
      io.grpc.MethodDescriptor.<com.tingyun.wade.server.manualflowcontrol.HelloRequest, com.tingyun.wade.server.manualflowcontrol.HelloReply>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
          .setFullMethodName(generateFullMethodName(
              "manualflowcontrol.StreamingGreeter", "SayHelloStreaming"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.tingyun.wade.server.manualflowcontrol.HelloRequest.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.tingyun.wade.server.manualflowcontrol.HelloReply.getDefaultInstance()))
          .build();
  ...
  public static abstract class StreamingGreeterImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<com.tingyun.wade.server.manualflowcontrol.HelloRequest> sayHelloStreaming(
        io.grpc.stub.StreamObserver<com.tingyun.wade.server.manualflowcontrol.HelloReply> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncBidiStreamingCall(
              new MethodHandlers<
                com.tingyun.wade.server.manualflowcontrol.HelloRequest,
                com.tingyun.wade.server.manualflowcontrol.HelloReply>(
  ...
  private static final class StreamingGreeterDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.tingyun.wade.server.manualflowcontrol.HelloStreamingProto.getDescriptor();
    }
  }
